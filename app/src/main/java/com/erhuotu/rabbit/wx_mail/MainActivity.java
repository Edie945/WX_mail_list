...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactNames = new String[] {"张三丰","哎妈呀","哎呦我去","不了啦","卜乐乐","额咦","颚了","飞了","菲菲","李四","粒子","娜扎","哪吒","哦哦","欧欧","潘家庄","裴擒虎","请财神","请考神","薯条","识别","徐","徐徐而来", "郭靖", "黄蓉", "黄老邪", "赵敏", "123", "天山童姥", "任我行", "于万亭", "陈家洛", "韦小宝", "$6", "穆人清", "陈圆圆", "郭芙", "郭襄", "穆念慈", "东方不败", "梅超风", "林平之", "林远图", "灭绝师太", "段誉", "鸠摩智"};
